...
/**
 * An Implementation of AStar for the Nebula Trajectory Generator
 * 
 * It is based on the code at https://s6.ee/VYPx
 */
class NebulaAStar {
    ...
    NebulaAStar(int[][] maze, int xstart, int ystart, boolean diag) {
